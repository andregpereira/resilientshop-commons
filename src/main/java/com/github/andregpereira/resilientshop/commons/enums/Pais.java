package com.github.andregpereira.resilientshop.commons.enums;
...
public enum Pais {
    ...
    @JsonCreator
    public static Pais consultarPorNomeOuDdi(String nome, String ddi) {
    ...
    private static Optional<Pais> matchByPredicate(Predicate<Pais> predicate) {
    ...
    public String toString() {
        return new StringJoiner(", ", Pais.class.getSimpleName() + "[", "]").add("nome='" + nome + "'").add(
